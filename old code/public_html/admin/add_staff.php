...
if(isset($_POST['add_staff'])) {
    ...
    if ($count > 0) {
        ...
        $insertQuery = "INSERT INTO tblemployees (FirstName, LastName, EmailId, Password, Gender, Dob, Department, Address, role, Phonenumber, Status, location) VALUES ('$fname', '$lname', '$email', '$password', '$gender', '$dob', '$department', '$address', '$user_role', '$phonenumber', '$status', 'NO-IMAGE-AVAILABLE.jpg')";
        
        if(mysqli_query($conn, $insertQuery)) {
            echo '<script>alert("User Records Successfully Added");</script>';
        } else {
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">User Info</h4>
                            <p class="mb-20"></p>
                        </div>
                    </div>
                        ...
                        <form method="post" action="">
                            <section>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label>Trained Days:</label>
                                            <input name="trained_days" type="number" class="form-control" required="true" autocomplete="off">
                                        </div>
                                    </div>
