...
<?php
	...
	{ 
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblrequest, tblemployees set tblrequest.registra_remarks='$description',tblrequest.admin_status='$status',tblrequest.AdminRemarkDate='$admremarkdate' where tblrequest.empid = tblemployees.emp_id AND tblrequest.id='$did'");
