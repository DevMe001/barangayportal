...
<body>
							...
							<div class="profile-tab height-100-p">
								<div class="tab height-100-p">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#timeline" role="tab">Request Records</a>
										</li>
										<li class="nav-item">
    ...
    <div class="pd-20">
        <div class="profile-timeline">
            <?php
            $query = mysqli_query($conn, "SELECT * FROM tblrequest WHERE empid = '$session_id' ORDER BY PostingDate DESC") or die(mysqli_error());
                ...
                <div class="profile-timeline-list">
                    <ul>
                        <li>
																...
																<div class="task-name"><i class="ion-ios-chatboxes"></i><?php echo $row['RequestType']; ?></div>
