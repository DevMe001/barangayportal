			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Your commitment to excellence and dedication to the well-being of our residents do not go unnoticed. This barangay is not just a workplace; it's a supportive and collaborative environment where every contribution is recognized and appreciated.</p>
					</div>
				</div>
			</div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<td>
									<div class="table-actions">
										<a title="VIEW" href="request.php?edit=<?php echo htmlentities($result->id);?>" data-color="#265ed7"><i class="icon-copy dw dw-eye"></i></a>
									</div>
								</td>
							</tr>
							<?php $cnt++;} }?>
