...
if (isset($_POST['apply'])) {
    ...
    if ($user) {
        ...
        $sql = "INSERT INTO tblrequest (registra_remarks, num_days, FirstName, LastName, EmailId, RequestType, ToDate, FromDate, Description, Status, IsRead, empid, PostingDate) 
                VALUES (:registra_remarks, :num_days, :firstname, :lastname, :emailid, :request_type, :fromdate, :todate, :description, :status, :isread, :empid, :datePosting)";
        $query = $dbh->prepare($sql);

        // Bind the user details
        $query->bindValue(':registra_remarks', 'default_value', PDO::PARAM_STR); // Replace 'default_value' with the actual default value or set NULL if allowed
        $query->bindParam(':num_days', $num_days, PDO::PARAM_INT);
