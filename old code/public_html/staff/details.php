...
<?php
	...
	{ 
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblrequest, tblemployees set tblrequest.registra_remarks='$description',tblrequest.Status='$status',tblrequest.AdminRemarkDate='$admremarkdate' where tblrequest.empid = tblemployees.emp_id AND tblrequest.id='$did'");
                    ...
                    <form method="post" action="">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3">
                            ...
                            <?php 
                            if(($stats==0 AND $ad_stats==1) OR ($stats==2 AND $ad_stats==0) OR ($stats==2 AND $ad_stats==2))
