...
<?php 
	 if (isset($_GET['delete'])) {
		...
		if ($result) {
			echo "<script>alert('Request type deleted Successfully');</script>";
 ...
 if(isset($_POST['edit']))
{
	 ...
	 $dteto=date('Y-m-d', strtotime($_POST['date_to_valid']));

    $result = mysqli_query($conn,"update tblrequesttype set RequestType='$requesttype', Description='$description', date_from='$dtefrom', date_to_valid='$dteto' where id = '$get_id' ");
    if ($result) {
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Edit Request Type</h2>
								<section>
									<?php
									$query = mysqli_query($conn,"SELECT * from tblrequesttype where id = '$get_id'")or die(mysqli_error());
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="requesttype" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['RequestType']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="date_to_valid" class="form-control" type="date" value="<?php echo $row['date_to_valid']; ?>">
											</div>
										</div>
									</div>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">Request List</h2>
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										...
										<tbody>
											...
											<tr>
	                                            ...
	                                            <td><?php echo htmlentities($result->date_from." - ".$result->date_to_valid);?></td>
												<td>
