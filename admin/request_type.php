...
if (isset($_POST['add'])) {
    ...
    $date_to_valid = date('Y-m-d', strtotime($_POST['date_to_valid']));
    ...
    if ($count > 0) { 
        ...
        $query = mysqli_query($conn, "insert into tblrequesttype (RequestType, Description, date_from, date_to_valid) values ('$requesttype', '$description', '$date_from', '$date_to_valid')") or die(mysqli_error()); 
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Request Module</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name="date_to_valid" class="form-control" type="date">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-actions">
                                                        <a href="edit_request_type.php?edit=<?php echo htmlentities($result->id); ?>" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
